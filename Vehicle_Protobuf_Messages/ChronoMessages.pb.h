...
class VehicleMessageDefaultTypeInternal;
extern VehicleMessageDefaultTypeInternal _VehicleMessage_default_instance_;
class VehicleMessage_MQuaternion;
class VehicleMessage_MQuaternionDefaultTypeInternal;
extern VehicleMessage_MQuaternionDefaultTypeInternal _VehicleMessage_MQuaternion_default_instance_;
class VehicleMessage_MVector;
class VehicleMessage_MVectorDefaultTypeInternal;
extern VehicleMessage_MVectorDefaultTypeInternal _VehicleMessage_MVector_default_instance_;
}  // namespace ChronoMessages
...
class VehicleMessage_MVector : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:ChronoMessages.VehicleMessage.MVector) */ {
 public:
  ...
  static inline const VehicleMessage_MVector* internal_default_instance() {
    return reinterpret_cast<const VehicleMessage_MVector*>(
  ...
  inline VehicleMessage_MVector* New() const PROTOBUF_FINAL { return New(NULL); }

  VehicleMessage_MVector* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
 ...
 private:
  ...
  double y_;
  double z_;
  friend struct  protobuf_ChronoMessages_2eproto::TableStruct;
};
// -------------------------------------------------------------------
...
class VehicleMessage_MQuaternion : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:ChronoMessages.VehicleMessage.MQuaternion) */ {
 public:
  ...
  static inline const VehicleMessage_MQuaternion* internal_default_instance() {
    return reinterpret_cast<const VehicleMessage_MQuaternion*>(
  ...
  inline VehicleMessage_MQuaternion* New() const PROTOBUF_FINAL { return New(NULL); }

  VehicleMessage_MQuaternion* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
...
class VehicleMessage : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:ChronoMessages.VehicleMessage) */ {
 public:
  ...
  static inline const VehicleMessage* internal_default_instance() {
    return reinterpret_cast<const VehicleMessage*>(
  ...
  inline VehicleMessage* New() const PROTOBUF_FINAL { return New(NULL); }

  VehicleMessage* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
 ...
 private:
  ...
  void set_has_chtime();
  void clear_has_chtime();
  void set_has_speed();
  void clear_has_speed();
  void set_has_chassiscom();
  void clear_has_chassiscom();
  void set_has_frontrightwheelcom();
  void clear_has_frontrightwheelcom();
  void set_has_frontleftwheelcom();
  void clear_has_frontleftwheelcom();
  void set_has_backrightwheelcom();
  void clear_has_backrightwheelcom();
  void set_has_backleftwheelcom();
  void clear_has_backleftwheelcom();
  void set_has_chassisrot();
  void clear_has_chassisrot();
  void set_has_frontrightwheelrot();
  void clear_has_frontrightwheelrot();
  void set_has_frontleftwheelrot();
  void clear_has_frontleftwheelrot();
  void set_has_backrightwheelrot();
  void clear_has_backrightwheelrot();
  void set_has_backleftwheelrot();
  void clear_has_backleftwheelrot();
